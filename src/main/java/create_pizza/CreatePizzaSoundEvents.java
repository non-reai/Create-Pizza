...
public class CreatePizzaSoundEvents {
	...
	public static final SoundEntry
		TOMATO_JAM = create("tomato_jam").build(),
		PIZZA = create("pizza").build(),
		SPLAT = create("splat").build();
	...
	private static SoundEntryBuilder create(String name) {
		return create(CreatePizza.asResource(name));
	}
	...
	public static class SoundEntryBuilder {
		...
		public SoundEntryBuilder addVariant(String name) {
			return addVariant(CreatePizza.asResource(name));
		}
