...
//					.lang("Chocolate")
					...
					.fluidAttributes(() -> new CreateAttributeHandler("block.create_pizza.tomato_sauce", 1500, 1400))
					.onRegisterAfter(Registries.ITEM, tomato_sauce -> {
						Fluid source = tomato_sauce.getSource();
						// transfer values
